...
// 横向きのスマホ (縦積みのまま) と、PCの横長 (左右に分かれる) の両方を残す
await shoot('phone-landscape-redact', { width: 844, height: 390, route: '#/redact', setup: loadIntoRedact });
await shoot('pc-landscape-redact', { width: 1280, height: 800, route: '#/redact', setup: loadIntoRedact });
await shoot('pc-landscape-organize', { width: 1280, height: 800, route: '#/organize', setup: loadIntoOrganize });
