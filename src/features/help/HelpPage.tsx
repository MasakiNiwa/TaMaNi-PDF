      ...
      <section className="section">
        ...
        <div className="card card--outlined">
          <ol style={{ marginTop: 0, paddingLeft: '1.2em' }}>
            ...
            <li>
              各ページの右上にある<strong>つまみ</strong> (点が6つ並んだ印) をドラッグすると並べ替えられます。
              スマホでは、つまみを押さえたまま指を動かしてください。つまみ以外をなぞったときは、
              並べ替えではなく一覧のスクロールになります。
            </li>
          ...
          <div className="card card--outlined">
            ...
            <ul style={{ marginTop: 0, paddingLeft: '1.2em' }}>
              <li>
                ...
                まわりに出る<strong>つまみ</strong>を引けば大きさを変えられます。
              </li>
              <li>
                <strong>拡大</strong>してから指定すると、細かい位置まで正確に合わせられます。
                拡大中は「移動」に切り替えると、画面をスワイプして見たい場所へ動かせます。
              </li>
              <li>右側 (スマホでは下) の一覧からも、範囲を選んだり削除したりできます。</li>
            </ul>
            <p style={{ marginBottom: 0 }}>
              別のPDFを扱いたくなったら、画面右上の
              <strong>クリア</strong>で最初の画面に戻せます。保存済みのテンプレートは消えません。
            </p>
          </div>
