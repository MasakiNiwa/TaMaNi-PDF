        ...
        <div className="card card--outlined">
          <ol style={{ marginTop: 0, paddingLeft: '1.2em' }}>
            <li>
              ...
              <strong>画像 (JPEG・PNG) から始めることも、空白ページから始めることもできます。</strong>
            </li>
            <li>
      ...
      <section className="section">
        ...
        <div className="stack">
          <div className="card card--outlined">
            ...
            <p>
              色・適用先・拡大・ページ送り・テンプレートは、画面の上に貼り付くツールバーにまとまっています。
              PDFを下までたどらなくても操作できます。
            </p>
            <p>
            ...
            <ul style={{ marginTop: 0, paddingLeft: '1.2em' }}>
              ...
              <li>
                プレビューの高さは画面に収まる範囲に抑えてあります。小さく見えるときは拡大してください。
              </li>
            ...
            <p style={{ marginBottom: 0 }}>
              別のPDFを扱いたくなったら、<strong>クリア</strong>で最初の画面に戻せます。
              保存済みのテンプレートは消えません。
            </p>
          </div>
